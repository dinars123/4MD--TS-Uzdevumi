...
console.log(myFunctionThirtySix([{a:1,b:2},{a:5,b:4}]))
console.log(myFunctionThirtySix([{a:2,b:10},{a:5,b:4}]))
console.log(myFunctionThirtySix([{a:1,b:7},{a:2,b:1}]))
...
console.log(myFunctionFortyFive({  continent: 'Asia',  country: 'Japan'}, 'continent'))
console.log(myFunctionFortyFive({  country: 'Sweden',  continent: 'Europe'}, 'country'))
...
function myFunctionFiftyThree (one: Record<string, any>, two: Record<string, any> ): Record<string, any> {
...
console.log(myFunctionFiftySeven({fn: 'Lisa', ln: 'Müller', age: 17, size: 175, weight: 67}))
console.log(myFunctionFiftySeven({fn: 'Martin', ln: 'Harper', age: 26, email: 'martin.harper@test.de', weight: 102}))
console.log(myFunctionFiftySeven({fn: 'Andrew', ln: 'Harper', age: 81, size: 175, weight: 71}))
console.log(myFunctionFiftySeven({fn: 'Matthew', ln: 'Müller', age: 19, email: 'matthew@mueller.de'}))
...
function myFunctionFiftyEight(arr: Record<string, any>[], continent: string): Record<string, any>[] {
...
console.log(myFunctionFiftyEight([{ city: 'Tokyo', country: 'Japan' }, { city: 'Bangkok', country: 'Thailand' }], 'Asia'))
console.log(myFunctionFiftyEight([{ city: 'Stockholm', country: 'Sweden' }, { city: 'Paris', country: 'France' }], 'Europe'))
...
console.log(myFunctionSixty(new Date('2000/01/01 08:00:00'), new Date('2000/01/01 08:45:00')))
console.log(myFunctionSixty(new Date('2000/01/01 08:00:00'), new Date('2000/01/01 08:00:00')))
console.log(myFunctionSixty(new Date('2001/01/01 08:00:00'), new Date('2000/01/01 08:00:00')))
...
console.log(myFunctionSixtyThree(new Date('2000/01/01'), new Date('2000/01/01')))
console.log(myFunctionSixtyThree(new Date('2000/01/01'), new Date('2000/01/02')))
console.log(myFunctionSixtyThree(new Date('2001/01/01'), new Date('2000/01/01')))
console.log(myFunctionSixtyThree(new Date('2000/11/01'), new Date('2000/01/01')))
...
function myFunctionSixtyEight(obj1: Record<string, any>, obj2: Record<string, any>): Record<string, any> {
  return { ...obj1, ...obj2 };
}
...
function myFunctionSixtyNine(obj: Record<string, any>, movie: string): Record<string, any> {
